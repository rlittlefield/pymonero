...
# Added aes_tables lookups to make galois multiplication not suck:
# https://github.com/caller9/pythonaes/blob/master/aespython/aes_cipher.py
import os
import sys
import math
import aes_tables
...
class AES(object):
    ...
    def mixColumn(self, column, inverse):
